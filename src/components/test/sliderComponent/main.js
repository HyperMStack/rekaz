import { S as e, N as t } from "./asset.js";
    ...
    modules: [
      ...
      function ({ swiper: e, extendParams: t, on: r, emit: s }) {
                ...
                s.forEach((r, i) => {
                  0 === t
                    ? ((r.style.transitionTimingFunction = "ease-out"),
                      (r.style.transitionDuration = `${e.params.speed + (e.params.speed / (s.length - 1)) * (s.length - i - 1)}ms`))
        ...
        r("setTranslate", () => {
          ...
          r("init", () => {
            "slicer" === e.params.effect &&
              (i(), s("setTranslate", e, e.translate));
          }),
          r("resize init", () => {
