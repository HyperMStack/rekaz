...
function setupEventListeners(transition) {
  ...
  class K {
    ...
    animateUniform(e, t, n) {
      ...
      const s = t > e.value ? "next" : "prev",
        ...
        l = () => {
          ...
          const s = Math.max(
              Math.min((i - r) / this.swiper.params.speed, 1),
              0
            ),
            c = 0.5 - Math.cos(s * Math.PI) / 2;
          let m = o + c * (t - o);
    ...
    createMaterial() {
      return new h(
        ...
        ((e, r) => {
          ...
          if (t) for (var s of t(r)) o.call(r, s) && i(e, s, r[s]);
          return e;
        })(
          {
            extensions: {
    ...
    setProgress(e, t, n, o, i) {
      ...
      if (
        ...
        this.shader.vertex
          ? (this.vertexMaterial.uniforms.texture1.value = r)
          ...
          t("setTranslate", () => {
            ...
            if (
              (e.slides.forEach((o, i) => {
                const r = o.progress;
                e.params.cssMode && 0 === Math.round(100 * r) && (c = !0),
                  ((r > 0 && r < 1) || (0 === r && e.progress < s)) &&
                    ((t = i), (n = i + 1), (a = r), (l = t)),
                  ((r < 0 && r > -1) || (0 === r && e.progress > s)) &&
                    ((t = i - 1), (n = i), (a = 1 + r), (l = n));
              }),
            ...
            e.params.loop || h === m || ((t = m), (n = h)),
              e.gl.setProgress(t, n, a, r, c);
          }),
          t("setTransition", (t, n) => {
            "gl" !== e.params.effect ||
              o ||
              e.glDestroyed ||
              (r = n > 0 && !e.params.cssMode);
          }),
